all:
	...
	rm -rf inventory;
	rm -rf catalog application_dir deployment_specs deployment_specs_test catalog_specs_test catalog_specs;
	rm -rf doc;
	rm -rf test_ebin;
...
build:
	...
	rm -rf log resource_discovery etcd;
	rm -rf inventory;
	rm -rf catalog application_dir deployment_specs_test deployment_specs catalog_specs_test catalog_specs;
	rm -rf doc;
	rm -rf test_ebin;
	#INFO: Deleting tilde files and beams
	rm -rf *~ */*~ */*/*~;
